...
public class SpellCommand implements AutoRegister<SpellCommand> {
	...
	@GameCommand(aliases = {"solar"}, desc = "Open the solar spellbook", help = "/solar", player = true)
	public void onSolar(Player p, String[] args){
		invManager.displayGui(p, new GuiSolarSpells(main));
	}
	
	@GameCommand(aliases = {"lunar"}, desc = "Open the lunar spellbook", help = "/lunar", player = true)
