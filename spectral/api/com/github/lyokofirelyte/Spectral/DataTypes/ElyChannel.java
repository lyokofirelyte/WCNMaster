...
public enum ElyChannel {
	...
	STAFF("STAFF", "wa.staff.intern", "&c&oOh! &4\u2744", "&c"),
	...
	public void send(String sender, String message, SpectralAPI api){
	...
	public void send(String sender, String message, String header, String color, String perm, SpectralAPI api){
		info[1] = perm;
		info[2] = header;
		info[3] = color;
	...
	public void send(String sender, String message, String perm, SpectralAPI api){
		info[1] = perm;
		send(sender, message, api);
	}
