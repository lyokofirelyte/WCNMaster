package com.github.lyokofirelyte.Spectral.Public;
...
import com.github.lyokofirelyte.Spectral.Public.RefUtils.PackageType;
import com.github.lyokofirelyte.Spectral.Public.RefUtils.PacketType;
	...
	public static final class ParticleEffectPacket {
		...
		/*public static void initialize() throws VersionIncompatibleException {
			...
			try {
				...
				packetConstructor = RefUtils.getConstructor(packetClass);
				getHandle = RefUtils.getMethod("CraftPlayer", PackageType.CRAFTBUKKIT_ENTITY, "getHandle");
				playerConnection = RefUtils.getField("EntityPlayer", PackageType.MINECRAFT_SERVER, false, "playerConnection");
				sendPacket = RefUtils.getMethod(playerConnection.getType(), "sendPacket", PackageType.MINECRAFT_SERVER.getClass("Packet"));
